...
# custom user auth model
  ...
  # addition of template base.html
  TEMPLATES = [
      {
...
#   }
  ...
  TIME_ZONE = values.Value("UTC") #'UTC"
...
class Prod(Dev):
    #DEBUG = False
    """We can’t use Value here, because in Python non-empty strings are truthy. 
    So we could try to set DEBUG to the string "false" and it would evaluate to true! 
    We need to use a BooleanValue class instead.
    """

    DEBUG = values.BooleanValue(True)
    SECRET_KEY = values.SecretValue()

    # inherits from class Dev
    #ALLOWED_HOSTS = values.ListValue(["localhost", "0.0.0.0", ".codio.io"])
